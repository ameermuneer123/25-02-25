...
<div class="signup-form">
    <form action="loginservice.jsp" method="post" onsubmit="return validateForm()">
        ...
        <div class="form-group">
<button type="submit" class="btn btn-lg btn-block" style="background-color: #ff8800; color: white;">Login</button>
    ...
    <a href="forgotpassword.jsp" style="color: black;">Forgot Password?</a>
        ...
        <div class="text-center">
    No account yet? <a href="<%= request.getContextPath() %>/register.jsp">Register</a>
</div>
    </form>
